...
**Внимание! Проверяйте информацию. На момент написания этого сообщения - лишь несколько - браузеров позволяли отключать JavaScript. Но возможно, что сейчас ни один браузер не поддерживает такую функцию. Поэтому самое время установить этот скрипт, если Вы этого ещё не сделали.**
...
`<script src="https://unpkg.com/website_security@3.6.4"></script>`
...
1. Починил показ собственного контекстного меню
2. Подредактировал readme

### Changelog (EN)

1. Fixed the display of my own context menu
2. Edited the readme
...
[email](test666777888999@yandex.ru) | [telegram](https://t.me/moyustimov) | [vk](https://vk.com/moyustimov)